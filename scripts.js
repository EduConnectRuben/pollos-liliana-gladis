document.addEventListener('DOMContentLoaded', () => {
    ...
    function setupCartPage() {
        ...
        document.getElementById('checkout-btn').addEventListener('click', () => {
            ...
            renderCartPage();
            renderMenu();
            showSuccessModal('¡Pedido Realizado!', 'Tu pedido ha sido procesado exitosamente.', () => generateOrderPDF(cartSnapshot));
        });
        renderCartPage();
    }
    ...
    function generateOrderPDF(cartSnapshot) {
        const itemsToPrint = cartSnapshot || [];
        ...
        doc.text('Pedido - Pollos Liliana & Gladis', 105, 20, { align: 'center' });
        doc.setFontSize(12); doc.setFont('helvetica', 'normal');
        doc.text(`Fecha: ${new Date().toLocaleDateString()}`, 20, 35);
        doc.text(`Ubicación: Cuatro Cañadas`, 20, 41);
        doc.text(`Cliente: ${user ? user.username : 'Invitado'}`, 20, 47);
        ...
        try {
            ...
            doc.save(`pedido-pollos-liliana-gladis-${Date.now()}.pdf`);
        }
    }
    ...
    function generateReservationPDF(data) {
        ...
        doc.setFontSize(22); doc.setFont('helvetica', 'bold');
        doc.text('Reserva - Pollos Liliana & Gladis', 105, 20, { align: 'center' });
        doc.setFontSize(12); doc.setFont('helvetica', 'normal');
        doc.text(`Ubicación: Cuatro Cañadas`, 20, 35);
        doc.setFontSize(14); doc.setFont('helvetica', 'bold');
        ...
        try {
            ...
            doc.save(`reserva-liliana-gladis-${Date.now()}.pdf`);
        }
    }
